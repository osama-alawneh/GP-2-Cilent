...
const phoneValidation = /^(00962|962|\+962|07)(7|8|9)([0-9]{7})$/;
...
function firstLastNameValidator(element){
  if (element.value.length < 3 || element.value.length > 13){
    redBorder(element);
...
document.addEventListener('input' , () =>{
  firstLastNameValidator(firstName);
  firstLastNameValidator(lastName);
  nationalIdValidator(nationalId);
